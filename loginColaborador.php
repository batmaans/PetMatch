...
<head>
  ...
  <title>PetMatch - Login Colaborador</title>
  ...
  <header class="corsec">
    ...
    <img class ="fundoDivertido" src="img/fundoDivertido2.png" alt="pets diversos">
      <div class="janRedSenha">
          <h2 class="titulo">Login Colaborador</h2>
              <form class="formulario">
                  <input type="email" id="email" name="email" placeholder="Email" required>
                  <input type="password" name="password" placeholder="Senha" required>
                  <button type="submit" class="botaoEnviar"><h2><a class="textoBranco" href="ColabAreaColaborador.php">ENTRE</a></button></h2>
              </form>
          <nav>
